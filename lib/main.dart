...
import 'utilities/web3dartutil.dart' as web3util;
  ...
  runApp(
    MaterialApp(
      ...
      routes: {
        ...
        '/output': (context) => const SecondScreen(),
      },
    ),
  );
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> initialSetup() async {
    web3util.Web3DartHelper().initState();
    // var getBlkNum = await web3util.Web3DartHelpeer().
    web3util.Web3DartHelper().

    var getBalance = await web3util.Web3DartHelper().balanceEther();
